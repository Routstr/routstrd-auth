...
export ROUTSTRD_DB_PATH="${ROUTSTRD_DB_PATH:-/app/data/routstr.db}"
...
if [[ ! -f /app/data/.initialized ]]; then
    ...
    gosu cloudron:cloudron env HOME="$HOME" ROUTSTRD_DIR="$ROUTSTRD_DIR" cocod init </dev/null 2>&1 || true
